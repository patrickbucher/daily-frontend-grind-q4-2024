const SCRIPTS = [
  ...
  {
    name: "Armenian",
    ranges: [[1329, 1367], [1369, 1376], [1377, 1416], [1418, 1419], [
      1421,
      1424,
    ], [64275, 64280]],
    direction: "ltr",
  ...
  {
    name: "Cypriot",
    ranges: [[67584, 67590], [67592, 67593], [67594, 67638], [67639, 67641], [
      67644,
      67645,
    ], [67647, 67648]],
    direction: "rtl",
  ...
  {
    name: "Duployan",
    ranges: [[113664, 113771], [113776, 113789], [113792, 113801], [
      113808,
      113818,
    ], [113820, 113824]],
    direction: "ltr",
  ...
  {
    name: "Hiragana",
    ranges: [[12353, 12439], [12445, 12448], [110593, 110879], [
      127488,
      127489,
    ]],
    direction: "ltr",
  ...
  {
    name: "Pahawh Hmong",
    ranges: [[92928, 92998], [93008, 93018], [93019, 93026], [93027, 93048], [
      93053,
      93072,
    ]],
    direction: "ltr",
  ...
  {
    name: "Tai Tham",
    ranges: [[6688, 6751], [6752, 6781], [6783, 6794], [6800, 6810], [
      6816,
      6830,
    ]],
    direction: "ltr",
  ...
  {
    name: "Limbu",
    ranges: [[6400, 6431], [6432, 6444], [6448, 6460], [6464, 6465], [
      6468,
      6480,
    ]],
    direction: "ltr",
  ...
  {
    name: "Multani",
    ranges: [[70272, 70279], [70280, 70281], [70282, 70286], [70287, 70302], [
      70303,
      70314,
    ]],
    direction: "ltr",
...
function dominantWritingDirection(text) {
  ...
  for (const c of text) {
    const script = SCRIPTS.find((s) => {
      ...
      return s.ranges.some(([lower, upper]) =>
        lower <= codePoint && upper >= codePoint
      );
    });
    if (!script) {
      continue;
